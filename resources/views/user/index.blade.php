            ...
            <div class="col-lg-5 d-flex align-items-stretch">
                <div class="info">
                    <div class="address">
                        ...
                        <h4>Location:</h4>
                        <p>54/2463, Daganiya, Amanaka, Raipur, Chhattisgarh 492001</p>
                    </div>

                    <div class="email">
                        <i class="bi bi-envelope"></i>
                        <h4>Email:</h4>
                        <p>@if(empty(auth()->user() )) kamlesh52170@gmail.com  @else {{ auth()->user()->email }} @endif</p>
                    </div>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.8885404224466!2d81.606391!3d21.236268!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a28ddd92adbb5eb%3A0x2103c03dcfdfa4a5!2sAghariya%20Samaj%20Seva%20Samiti(%20Boys%20Hostel)!5e0!3m2!1sen!2sin!4v1710783228005!5m2!1sen!2sin" width="100%" height="290px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            ...
            <div class="col-lg-7 align-items-stretch">
                <div class="card bg-light">
                    <div class="card-header bg-secondary">
                        <div class="text-center ">Enquiry Form</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('enquiry') }}" method="POST">
                            @csrf
                                ...
                                <div class="text-center"><button type="submit" class="btn btn-sm btn-primary" id="submit" >Send Message</button></div>
                            </form>
                    </div>
                </div>
